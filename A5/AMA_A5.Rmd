...
```
The leave-one-out cross-validation determines 2.49 as optimal bandwidth. The fit of the local Poisson regression looks smooth and reasonable. It follows the course of high density of points while generalizing to all data. We do not observe overfitting.
